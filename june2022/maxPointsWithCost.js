var maxPoints = function(points) {
    ...
    loop through each row starting from the second row and add the each num from the above row and subtract abs(c1 - c2) and save that in that grid slot

    return the max num in the last row
    */
};
